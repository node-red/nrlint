module.exports = {
    "align-to-grid": require("./align-to-grid"),
    "max-flow-size": require("./max-flow-size"),
    "no-duplicate-http-in-urls": require("./no-duplicate-http-in-urls"),
    "no-loops": require("./no-loops"),
