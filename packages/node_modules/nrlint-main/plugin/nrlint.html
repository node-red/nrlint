    ...
    RED.plugins.registerPlugin('nrlint', {
        ...
        onadd: function() {
            ...
            RED.userSettings.add({
                ...
                close: function() {
                    var newSettings = {
                        rules: exportRuleSettings()
                    };
                    RED.settings.set("nrlint",newSettings);
                    queueLint();
                }
            })
            function exportRuleSettings() {
                var ruleSettings = {};
            ...
            function queueLint() {
                if (!lintTimer) {
                    lintTimer = setTimeout(function() {
                        lintTimer = null;
                        myWorker.postMessage({cmd:'lint', config: getLintSettings(), flow:RED.nodes.createCompleteNodeSet()})
                    },1000);
                }
            }
